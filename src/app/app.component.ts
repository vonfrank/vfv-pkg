...
export class AppComponent {
  ...
  testData: Object[][] = [
    [1, new Data("Rigor", 1), new Data("Relevance", 2), new Data("Title", "Von Frank is awesome"), new Data("Author", "Von Frank"), new Data("Year", 2000)],
    ...
    [5, new Data("Rigor", 1), new Data("Relevance", 2), new Data("Title", "Von Frank is awesome"), new Data("Author", "Von Frank"), new Data("Year", 2002)],
    ...
    [26, new Data("Rigor", 0.5), new Data("Relevance", 0), new Data("Title", "Von Frank is not awesome"), new Data("Author", "Marco K"), new Data("Year", 2011)],
