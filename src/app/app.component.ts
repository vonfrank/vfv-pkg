...
export class AppComponent {
  ...
  testData: Object[][] = [
    ...
    [5, new Data("Rigor", 1), new Data("Relevance", 2), new Data("Title", "Von Frank is awesome"), new Data("Author", "Von Frank"), new Data("Year", 2016)],
    [6, new Data("Rigor", 0.5), new Data("Relevance", 0), new Data("Title", "Von Frank is not awesome"), new Data("Author", "Marco K"), new Data("Year", 2013)],
    ...
    [9, new Data("Rigor", 1), new Data("Relevance", 2), new Data("Title", "Von Frank is awesome"), new Data("Author", "Von Frank"), new Data("Year", 2016)],
    ...
    [14, new Data("Rigor", 0.5), new Data("Relevance", 0), new Data("Title", "Von Frank is not awesome"), new Data("Author", "Marco K"), new Data("Year", 2013)],
    [15, new Data("Rigor", 1), new Data("Relevance", 4), new Data("Title", "Von Frank is not awesome"), new Data("Author", "Marco K"), new Data("Year", 2015)],
    [16, new Data("Relevance", 0), new Data("Title", "Von Frank is not awesome"), new Data("Author", "Marco K"), new Data("Year", 2016)],
    [17, new Data("Rigor", 1), new Data("Relevance", 2), new Data("Title", "Von Frank is awesome"), new Data("Author", "Von Frank"), new Data("Year", 2016)],
    ...
    [21, new Data("Rigor", 1), new Data("Relevance", 2), new Data("Title", "Von Frank is awesome"), new Data("Author", "Von Frank"), new Data("Year", 2016)],
    ...
    [23, new Data("Rigor", 1), new Data("Relevance", 4), new Data("Title", "Von Frank is not awesome"), new Data("Author", "Marco K"), new Data("Year", 2015)],
    ...
    [26, new Data("Rigor", 0.5), new Data("Relevance", 0), new Data("Title", "Von Frank is not awesome"), new Data("Author", "Marco K"), new Data("Year", 2013)],
    ...
    [30, new Data("Rigor", 0.5), new Data("Relevance", 0), new Data("Title", "Von Frank is not awesome"), new Data("Author", "Marco K"), new Data("Year", 2013)],
    ...
    [33, new Data("Herp", "Derp"), new Data("Derp", 0), new Data("Title", "Von Frank is not awesome"), new Data("Author", "Marco K"), new Data("Year", 2016)]];
